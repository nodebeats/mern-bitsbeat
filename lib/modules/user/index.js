        ...
        if (!validation.length > 0) {
            ...
            if (checkEmail) {
                ...
                if (agree_terms_condition === true) {
                    try {
                        let data = collection.insertOne({ first_name, last_name, email, password, salutation, user_role, agree_terms_condition, deleted, added_on });
                        ...
                        await tokenCollection.insertOne({user_email:email, token: tokenVerif, created_at: new Date(), expires: 43200 });
                        ...
                        nodemailer.createTestAccount((err, account) => {
                            ...
                            let mailOptions = {
                                ...
                                text: `You are succesfully signed up. Click this link to verify your email ` + link,
                                // html:'<b></b>'
                            };
