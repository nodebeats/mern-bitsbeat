...
var checkValidation = async (req) => {
    ...
    req.checkBody('user_role', configMessage.messageConfig.validationErrMessage.user_role_field).optional().isIn(['superuser', 'enduser','superadmin','normaluser','reader','writer']);
